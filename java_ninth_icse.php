  ...
  <div class="header-container">
    <div class="breadcrumb_container mt-5" style="height: 0px;">
      <nav aria-label="breadcrumb" style="padding-top: 20px;">
        <ol class="breadcrumb" style="background-color: rgb(245, 157, 42)">
          <li class="breadcrumb-item"><a href="./index.php" style="color: blue;">Home</a></li>
          <li class="breadcrumb-item"><a href="./index.php#courses" style="color: blue;">Courses</a></li>
          <li class="breadcrumb-item active " style="color: black;" aria-current="page">9th ICSE</li>
        </ol>
      </nav>
    </div>
          ...
          <div class="col-10 offset-1 offset-sm-0 col-md-6 mt-5">
            <div class="offer-card row">
              ...
              <div class="col-12 col-md-6">
                ...
                <a href="#"><button class="btn btn--outline btn-l btn--padding-l mt-2">
                    Want to know more?
                  </button>
                </a>
              </div>
      ...
      <div class="row" style="justify-content: center;">
        ...
        <div style="z-index: 1;" class="card card--shadow card--behind col-12 col-md-2">
          ...
          <div class="perks">
            ...
            <div class="perks-container">
              <img height="45px" src="https://notestwowaits.s3.us-east-1.amazonaws.com/notes/icon_support.png" class="ml-3 mt-2" style="justify-content: center;" />
              <div>
                <div class="text-orange text-size-m" style="justify-content: center;">Weekly </div>
                <div style="justify-content: center;" class="mb-3"> Live Doubt resolution</div>
              </div>
            </div>
            <div class="perks-container">
  ...
  <div class="syllabus-main-outer">
    <div class="syllabus-main">
      <div id="syllabus" class="container">
        ...
        <div class="row">
          <div class="syllabus offset-md-1 col-sm-12 col-md-10">
