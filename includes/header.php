...
<nav class="navbar navbar-dark navbar-expand-sm fixed-top" id="navbarcr">
    <div class="container">
      ...
      ?>
      <li class="nav-item "><a class="nav-link " style="color: white;" href ="#" ><i class="fas fa-user fa-lg"></i> <?php echo "Hello ". $_SESSION['first_name'];
      ?></a>
     <!--<div class="dropdown-menu" style="background-color: #CCCD6A;">-->
        ...
        <li class="nav-item"><a class="nav-link" href="index.php#courses" style="color: white;"><i class="fas fa-book-reader fa-lg" ></i> My Courses</a></li>
