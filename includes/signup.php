              ...
              <input type="hidden" name="csrf_test_name" value="ca472541f01935331cf951b3a6984a5d" />
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                      ...
                      placeholder="Password" required = "true" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number 
                      and one uppercase and lowercase letter, and at least 8 or more characters">
                      <small id="emailHelp" class="form-text text-muted">Your Password must contain one uppercase, one lowercase and atleast 8 characters</small>
                  </div>
                  <div class="form-group">
                    <label for="password"> Confirm Password</label>
                    <input type="password" class="form-control" id="modal_password" name="password_confirm"
                    placeholder="Confirm Password" required= "true" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Your password should be same as above">
