                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module2-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../java_10_icse/unary_operators.php" class="d-inline-flex align-items-center rounded active">Video: Unary Operators</a></li>
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        <h3 class="bd-title" id="content">Unary Operators In JAVA</h3>
                    </div>
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://www.youtube.com/embed/YvA91Rr3Ffc?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Java Tokens"></iframe></div>
                </div>
