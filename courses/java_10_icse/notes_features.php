        ...
        <div class="container-xxl my-md-3 bd-layout">
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="layout-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../java_10_icse/notes_features.php" class="d-inline-flex align-items-center rounded active"> Notes: Features Of Java</a></li>
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    ...
                    <ul mt-5>
                    <li style="font-size: medium;"><strong>Features Of Java</strong> <a href="../../notes/Introduction To JAVA.pdf" target="_blank" download="Introduction To JAVA" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></li>
                    </ul>
