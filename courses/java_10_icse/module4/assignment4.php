...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> Assignment-4 | Java Course 10th ICSE</title>
    </head>
    <style>
        body {
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module4-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module4/assignment4.php" class="d-inline-flex align-items-center rounded active">Assignment 4</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="mb-1">
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        <h1 class=" bd-title mb-4"> Assignment 4</h1>
                    </div>
                    <?php 
                        $user_id = $_SESSION['id'];
                        $query = "SELECT * FROM students_quiz WHERE user_id='$user_id' AND quiz_no='8' ";
                        ...
                        if($result!=0){
                            ...
                            echo '<div class="container w-100 p-3">
                                    <div class="row">
                                    <h5>The solution of the Assignment 4:-</h5>
                                    <a href="../notes/Assignment 4 Solution.pdf" target="_blank"> Download the solutions</a>
                    ...
                    <div class="form">
                            <ol class="list-numbered">
                                <li class="pb-2">WAP using multiple if-else to input a character and check whether it is alphabet, digit or a special character.<em>[Hint: Use ASCII Codes Table]</em><br>
                                <li class="pb-2">WAP using nested if-else to input the type & price of watch purchased, and calculate the discount according the given table and print the final price to be paid by the customer.<br><br>
                                 <table style="width: 100%;">
                                     <tr>
                                     <th>Price/Type of Watch</th>
                                     <th>Fastrack</th>
                                     <th>Titan</th>
                                     </tr>
                                     <tr>
                                ...
                                <li class="pb-2">WAP using nested if-else to input type, floor of the room & number of days for room booked, and print the total bill using the given table.<br>
                                <table style="width: 100%;">
                                     <tr>
                                     <th>Floor/Type</th>
                                     <th>AC</th>
                                ...
                                <li class="pb-2">What are the differences between Multiple If-Else and Switch Case?</li>
                                <li class="pb-2">Write a menu driven program using <b>Switch</b> to display the menu to the user and ask his/her choice. Depending on the user choice print the area, perimeter or diagonal of the rectangle taking length and 
                                    breadth of the rectangle as an input.<br>
                                    1. - Area of Rectangle<br>
                                    2. - Perimeter of Rectangle<br>
                                    3. - Diagonal of Rectangle<br>
                                </li>
                            </ol>
                            <div style="padding: 20px; border: 1px solid #999" id="upload">
                                ...
                                <h6 style="color: blue;">Save your pdf with your name before submitting. Example: YourName_Assignment4.pdf</h6>
