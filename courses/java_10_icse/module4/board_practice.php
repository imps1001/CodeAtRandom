...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> Board Practice Module 4 </title>
    </head>
    <style>
       body {
        ...
        <div class="container-xxl my-md-3 bd-layout">
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module4-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module4/board_practice.php" class="d-inline-flex align-items-center rounded active">Board Questions Practice</a></li>
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    ...
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://www.youtube.com/embed/2_jY5u-1TAQ?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Board Practice"></iframe></div>
                        <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        ...
                        <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
                            <tr>
                                ...
                                <td><a href="../../../notes/module 4/board questions.pdf" target="_blank" download="Previous year questions with their solutions based on module 3." style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
