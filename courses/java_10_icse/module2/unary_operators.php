...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> Unary Operators - Code At Random</title>
    </head>
    <style>
        body {
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="content-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module2/unary_operators.php" class="d-inline-flex align-items-center rounded active">Video: Unary Operators</a></li>
