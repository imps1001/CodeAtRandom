...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
       ...
       <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
        ...
        <title> Java Tokens - Code At Random</title>
    </head>
    <style>
        body {
                    ...
                    <ul class="list-unstyled mb-0 py-3 pt-md-1">
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="content-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    <li><a href="../../java_10_icse/module2/java_tokens.php" class="d-inline-flex align-items-center rounded active">Video: Java Tokens</a></li>
