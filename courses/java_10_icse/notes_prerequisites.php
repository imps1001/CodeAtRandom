        ...
        <div class="container-xxl my-md-3 bd-layout">
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    ...
                    <ul mt-5>
                    <li style="font-size: medium;"><strong>Introduction To Computers:- </strong> <a href="../../notes/Introduction to Computers.pdf" target="_blank" download="Introduction to Computers" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></li>
                    <li style="font-size: medium;"><strong>Types Of  Computer Languages:- </strong> <a href="../../notes/Types Of Computer Languages.pdf" target="_blank" download="Types Of Computer Languages" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></li>
                    </ul>
