...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> Static programming - Code At Random</title>
    </head>
    <style>
        body {
       ...
       <div class="container-xxl my-md-3 bd-layout">
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module3-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module3/static_programming.php" class="d-inline-flex align-items-center rounded active">Video: Static Programming </a></li>
            ...
            <main class="bd-main order-1">
                ...
                <div class="d-md-flex flex-md-row align-items-center justify-content-between">
                        ...
                        <p>In static programming, we will practice some basic programs based on arithmetic operators and other concepts. Here, we will use BlueJ as a programming software.</p>
                        <p>First, we will practice some basic programs and in the second video, the program of swapping of two numbers is covered. This question is very important for exams.</p>
                        <p>Happy Learning !!</p>
                        <ul>
                        <li id="video1" style="font-size: larger;">Static Programming-1 </li>
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://www.youtube.com/embed/MNKxRDVx36U?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:80%;" title="Static Programming-1"></iframe></div>
                        <li id="video2" style="font-size: larger;">Program on swapping of two numbers</li>
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://www.youtube.com/embed/CiuktlbdXI4?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:80%;" title="Program to swap two numbers"></iframe></div>
                        </ul>
                        ...
                        <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
                            <tr>
                                <td>
                                    <strong>Static Programming</strong>
                                </td>
                                <td><a href="../../../notes/module 3/static programming.pdf" target="_blank" download="Static programming" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>Swapping of two numbers</strong>
                                </td>
                                <td><a href="../../../notes/module 3/Swapping of two numbers.pdf" target="_blank" download="Swapping of two numbers" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                ...
                <div class="bd-toc mt-4 mb-5 my-md-0 ps-xl-3 mb-lg-5 text-muted">
                    ...
                    <nav id="TableOfContents">
                        <ul>
                            <li><a href="#video1">Programming Part 1</a></li>
                            <li><a href="#video2">Programming Part 2</a></li>
                            <li><a href="#notes">Notes to download</a></li>
