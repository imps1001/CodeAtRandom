...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> Board Practice Module 3 </title>
    </head>
    <style>
       body {
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module3-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module3/board_practice.php" class="d-inline-flex align-items-center rounded active">Board Questions:Programming</a></li>
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        <h3 id="video">Previous Year Questions with practice</h3>
                    </div>
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://www.youtube.com/embed/kDZfqJq_Zl8?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Dynamic programming"></iframe></div>
                        <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        ...
                        <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
                            <tr>
                                <td>
                                    <strong>Board practice</strong>
                                </td>
                                <td><a href="../../../notes/module 3/board questions.pdf" target="_blank" download="Previous year questions with their solutions based on module 3." style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
