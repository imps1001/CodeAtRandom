...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> Dynamic Programming in JAVA - Code At Random</title>
    </head>
    <style>
        body {
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module3-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module3/dynamic_programming.php" class="d-inline-flex align-items-center rounded active"> Video: Dynamic Programming</a></li>
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        <h3 id="video">How to do programming using Scanner Class? </h3>
                    </div>
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://www.youtube.com/embed/UUcycBs6C_8?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Dynamic programming"></iframe></div>
                        <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        <h3 id="notes" class="pt-5">Notes in pdf form </h3>
                        </div>
                        <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
                            <tr>
                                <td>
                                    <strong>Programming using Scanner Class in JAVA</strong>
                                </td>
                                <td><a href="../../../notes/module 3/dynamic programming.pdf" target="_blank" download="Static programming" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
