...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> Assignment-3 | Java Course 10th ICSE</title>
    </head>
    <style>
        body {
            ...
            if ( isset( $_FILES['file'] ) ) {
                if ($_FILES['file']['type'] == "application/pdf") {
                    ...
                    move_uploaded_file( $source_file, $dest_file ) or die("Error!! We can't transfer the file");
                        ...
                        values ('$user_id', '$course_id', '$quiz_no', '14')";
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module3-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module3/assignment3.php" class="d-inline-flex align-items-center rounded active">Assignment 3</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="mb-1">
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        <h1 class=" bd-title mb-4"> Assignment 3</h1>
                    </div>
                    <?php 
                        $user_id = $_SESSION['id'];
                        $query = "SELECT * FROM students_quiz WHERE user_id='$user_id' AND quiz_no='6' ";
                        ...
                        if($result!=0){
                            ...
                            <h2> Your assignment is submitted. Your score is '. $grade .' out of 14</h2><br>
                            </div>';
                            echo '<div class="container w-100 p-3">
                                    <div class="row">
                                    <h5>The solution of the Assignment 3:-</h5>
                                    <a href="../notes/Assignment 3 Solution.pdf" target="_blank"> Download the solutions</a>
                    ...
                    <div class="form">
                            <ol class="list-numbered">
                                <li class="pb-2">WAP to calculate and print the surface area of cuboid whose length, breadth and height will be given by the user.<br>
                                  <em>Surface area of cuboid is = 2lb+2bh+2bh</em></li>
                                <li class="pb-2">WAP to input two numbers from the user and find the maximum number between the two and print it as a output. [Using only math function]</li>
                                <li class="pb-2">WAP to evaluate the expression x = &radic;<span style="text-decoration: overline">a<sup>2</sup>+b<sup>2</sup></span>, where the value of a and b wil be given by the user and print the value of x.</li>
                                <li class="pb-2">WAP to evaluate the expression y = ax<sup>3</sup>+bx<sup>2</sup>+cx+d, where the value of a,b and x wil be given by the user and print the value of y.</li>
                                <li class="pb-2">What is the difference between math.ceil and math.floor?</li>
                                <li class="pb-2">Evaluate the value of y the following JAVA Expression: <br>
                                double y = Math.ceil(-31.887)+ Math.round(234.44)+Math.max(-45, -50)</li>
                                <li class="pb-2">	Write the equivalent JAVA Expression of S = ut + 1/2 at<sup>2</sup></li>
                            </ol>
                            <div style="padding: 20px; border: 1px solid #999" id="upload">
                                ...
                                <h6 style="color: blue;">Save your pdf with your name before submitting. Example: YourName_Assignment3.pdf</h6>
