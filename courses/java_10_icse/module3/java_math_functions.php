...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> Mathematical Functions - Code At Random</title>
    </head>
    <style>
        body {
       ...
       <div class="container-xxl my-md-3 bd-layout">
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module3-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module3/java_math_functions.php" class="d-inline-flex align-items-center rounded active">JAVA Mathematical Functions</a></li>
            ...
            <main class="bd-main order-1">
                ...
                <div class="d-md-flex flex-md-row align-items-center justify-content-between">
                        <h3 class="bd-title" id="content">Java Mathematical Functions</h3>
                    </div>
                        <p>On this page, there are two videos: One where we have covered all about JAVA Mathematical Functions and the Math Libray </p>
                        <p>And the other one contains the outputs and programming questions based on JAVA Mathematical functions.</p>
                        <p>Happy Learning !!</p>
                        <ul>
                        <li id="laptop" style="font-size: larger;">Introduction to Math Class</li>
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://www.youtube.com/embed/zeKvyX3y8Kg?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:80%;" title="BlueJ Installing in Laptop"></iframe></div>
                        <li id="mobile" style="font-size: larger;">Implementation of Math Class</li>
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://www.youtube.com/embed/PRA53otR6-E?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:80%;" title="Implementing Math Class "></iframe></div>
                        </ul>
                        ...
                        <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
                            <tr>
                                <td>
                                    <strong>JAVA Mathematical Functions</strong>
                                </td>
                                <td><a href="../../../notes/module 3/mathematical functions.pdf" target="_blank" download="JAVA Mathematical Functions" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>Implementation of Math Class</strong>
                                </td>
                                <td><a href="../../../notes/module 3/Implementation of math class.pdf" target="_blank" download="Implementation of Math Class" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                        </table>
                ...
                <div class="bd-toc mt-4 mb-5 my-md-0 ps-xl-3 mb-lg-5 text-muted">
                    ...
                    <nav id="TableOfContents">
                        <ul>
                            <li><a href="#laptop">Introduction to Math Class</a></li>
                            <li><a href="#mobile">Implementation of Math Class</a></li>
