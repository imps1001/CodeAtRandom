...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> JAVA Expressions - Code At Random</title>
    </head>
    <style>
        body {
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module3-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module3/expressions.php" class="d-inline-flex align-items-center rounded active">Board Questions: Expressions in JAVA</a></li>
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        <h3 id="video">JAVA Expressions  </h3>
                    </div>
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://www.youtube.com/embed/rvsTttlqQC8?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Dynamic programming"></iframe></div>
                        <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        ...
                        <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
                            <tr>
                                ...
                                <td><a href="../../../notes/module 3/expressions in java.pdf" target="_blank" download="JAVA Expressions" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
