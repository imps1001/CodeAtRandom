...
if (isset($_SESSION['email'])) { ?>
   ...
   <html lang="en">
    ...
    <head>
        ...
        <title> Notes-Module 3 - Code At Random</title>
    </head>
    <style>
        body {
                ...
                <div class="bd-intro ps-lg-4">
                    <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        ...
                        <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
                            ...
                            <tr>
                                <td>
                                    <strong>Taking Input in JAVA</strong>
                                </td>
                                <td><a href="../../../notes/module 3/taking input.pdf" target="_blank" download="Taking input in JAVA" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>Dynamic Programming</strong>
                                </td>
                                <td><a href="../../../notes/module 3/dynamic programming.pdf" target="_blank" download="Dynamic Programming" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>JAVA Mathematical Functions</strong>
                                </td>
                                <td><a href="../../../notes/module 3/mathematical functions.pdf" target="_blank" download="Mathematical Functions" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>Implementation of Mathematical Functions</strong>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <strong>Expressions in JAVA</strong>
                                </td>
                                <td><a href="../../../notes/module 3/expressions in java.pdf" target="_blank" download="Expressions in JAVA" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>Board Questions</strong>
                                </td>
                                <td><a href="../../../notes/module 3/board questions.pdf" target="_blank" download="Board Questions Practice" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                        </table>
