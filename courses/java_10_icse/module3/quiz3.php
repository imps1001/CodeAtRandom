...
<div class="container-xxl my-md-3 bd-layout">
            <aside class="bd-sidebar">
                <nav class="collapse bd-links" id="sidebar" aria-label="Docs navigation">
                    <ul class="list-unstyled mb-0 py-3 pt-md-1">
                        ...
                        <li class="mb-1">
                            <button class="btn d-inline-flex align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#module3-collapse" aria-expanded="true" aria-current="true">
                                Module 3
                            </button>
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        <h1 class=" bd-title mb-4">Quiz 3 - Module 3</h1>
                    </div>
                    <?php 
                        $user_id = $_SESSION['id'];
                        $query = "SELECT * FROM students_quiz WHERE user_id='$user_id' AND quiz_no='5' ";
                        ...
                        if($result!=0){
                            ...
                            echo '<div class="container w-100 p-3">
                                    <div class="row">
                                    <h5>The correct answers of the Quiz 3 were:-</h5>
                                    <p> 
                                    <ol> 
                                    <li> What will be the result of <strong> a=3/2</strong> if a is declared as int? - <strong>1</strong></li>
                                    <li> What will be the ouput of the following code? <br>
                                    double b = -15.6; <br>
                                    double a = Math.rint(Math.abs(b));<br>
                                    System.out.println(a); - <strong>16.0</strong></li>
                                    <li>What will be the result stored in x after the execution of this expression.<br>
                                    int x=5;<br>
                                    x = x++ * 2 + 3* ++x; - <strong> 25</strong></li>
                                    <li>  Which of the following package is invoked by default ? -> <strong> java.util  </strong></li>
                                    <li>  Which of the following keyword is used to import the classes from other packages? -> <strong> import</strong></li>
                                    </ol>
                                    </p>
                                    </div> </div>';
                        }
                    ...
                    <div class="form">
                        <form action="" method="POST" role="form" id="quiz-3">
                            ...
                            <ol class="list-numbered">
                                <li>What will be the result of <strong> a=3/2</strong> if a is declared as int? <br></li>
                                <input type="radio" id="one" name="question1" value="one">
                                <label for="one">1</label><br>
                                <input type="radio" id="oneplus" name="question1" value="oneplus">
                                <label for="oneplus">1.5</label><br>

                                <li>What will be the ouput of the following code? <br>
                                double b = -15.6; <br>
                                double a = Math.rint(Math.abs(b));<br>
                                System.out.println(a);<br></li>
                                <input type="radio" id="sixteen" name="question2" value="sixteen">
                                <label for="sixteen">16.0</label><br>
                                <input type="radio" id="fifteen" name="question2" value="fifteen">
                                <label for="fifteen">15.0 </label><br>

                                <li>What will be the result stored in x after the execution of this expression.<br>
                                 int x=5;<br>
                                 x = x++ * 2 + 3* ++x;</li>
                                <input type="radio" id="twentysix" name="question3" value="twentysix">
                                <label for="twentysix">26 </label><br>
                                <input type="radio" id="twentyfive " name="question3" value="twentyfive">
                                <label for="twentyfive">25 </label><br>
                                <input type="radio" id="fifty " name="question3" value="fifty">
                                <label for="fifty">50 </label><br>
                                <input type="radio" id="none " name="question3" value="none">
                                <label for="none">None of the above. </label><br>

                                <li>Which of the following package is invoked by default ?</li>
                                <input type="radio" id="math" name="question4" value="math">
                                <label for="math">java.math </label><br>
                                <input type="radio" id="lang " name="question4" value="lang">
                                <label for="lang">java.lang </label><br>
                                <input type="radio" id="util " name="question4" value="util">
                                <label for="util">java.util </label><br>
                                <input type="radio" id="all " name="question4" value="all">
                                <label for="all">All of the above</label><br>

                                <li>Which of the following keyword is used to import the classes from other packages?</li>
                                <input type="radio" id="class" name="question5" value="class">
                                <label for="class">class </label><br>
                                <input type="radio" id="system " name="question5" value="system">
                                <label for="system">system </label><br>
                                <input type="radio" id="import " name="question5" value="import">
    ...
    if (isset($_POST['submit'])) {
        ...
        if (strcmp($ques2, "sixteen") == 0) {
            $c++;
        }
        if (strcmp($ques3, "twentyfive") == 0) {
            $c++;
        }
        if (strcmp($ques4, "util") == 0) {
            $c++;
        }
        if (strcmp($ques5, "import") == 0) {
            $c++;
        }
        $grade = $c*10;
    $user_id = $_SESSION['id'];
