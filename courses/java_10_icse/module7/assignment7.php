...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> Assignment-7 | Java Course 10th ICSE</title>
    </head>
    <style>
        body {
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module7-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module7/assignment7.php" class="d-inline-flex align-items-center rounded active">Assignment 7</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="mb-1">
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        <h1 class=" bd-title mb-4"> Assignment 7</h1>
                    </div>
                    <?php 
                        $user_id = $_SESSION['id'];
                        $query = "SELECT * FROM students_quiz WHERE user_id='$user_id' AND quiz_no='14' ";
                        ...
                        if($result!=0){
                            ...
                            echo '<div class="container w-100 p-3">
                                    <div class="row">
                                    <h5>The solution of the Assignment 7:-</h5>
                                    <a href="../notes/Assignment 7 Solution.pdf" target="_blank"> Download the solutions</a>
                    ...
                    <div class="form">
                            <ol class="list-numbered" id="question1">
                                <li class="pb-2">Differentiate between :- 
                                    <ul>
                                        ...
                                        <li>Function and Constructors</li>
                                        <li>Actual Parameters and Formal Parameters</li>
                                ...
                                <li class="pb-2">WAP to create function <b>char isPalin(int n)</b> & float isAuto(int n) & print the PalinAuto numbers between 1 to 100.
                                </li>

                                <li class="pb-2">WAP to overload functions:<br>
                                    <ul>
                                        <li><b>double series(int n):</b>  to print the sum of series:<br>
                                        S= 1 + 1/2 + 1/3 + 1/4 + .... n terms
                                        </li>
                                        <li><b>double series(double a, double b): </b> print the sum of series- <br>
                                          S = 1/a<sup>2</sup> + 4/a<sup>5</sup> + 7/ a<sup>8</sup> + ..... +n terms
                                       </li>
                                    </ul>
                            </li>

                                <li class="pb-2">What is Function Overloading. Explain with example. </li> 
                                <li class="pb-2">Predict the output? <br>
                                class T {<br>
                                    &nbsp;int t = 20;<br>
                                 public static void main( ){<br>
                                        &nbsp;T t1 = new T();<br>
                                        &nbsp;System.out.println(t1.t);<br>
                                    }<br>
                                }<br>   
                            </li>
                            </ol>
                            <div style="padding: 20px; border: 5px solid #333" id="upload">
                                ...
                                <h6 style="color: blue;">Save your pdf with your name before submitting. Example: YourName_Assignment7.pdf</h6>
