                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="customize-collapse">
                                <ul class="list-unstyled fw-normal pb-2 small">
                                    ...
                                    <li><a href="../../java_10_icse/pre_requisites/reading_introduction_to_java.php" class="d-inline-flex align-items-center rounded pb-1 active">Reading: Java: Introduction</a></li>
