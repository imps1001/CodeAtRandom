            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    ...
                    <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
                            <tr>
                                <td>
                                    <strong>Elementary Concepts of Java</strong>
                                </td>
                                <td><a href="../../notes/Elementary Concepts of Java.pdf" target="_blank" download="Elementary Concepts of Java" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                    </table>
