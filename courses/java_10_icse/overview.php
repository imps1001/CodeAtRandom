            ...
            <main class="bd-main order-1">
                ...
                <div class="card" >
                        ...
                        <div class="card-body collapse show" id="module2_collapse">
                            <ul class="list-unstyled fw-normal pb-1 small">
                                ...
                                <li><a href="#"class="d-inline-flex align-items-center rounded" style="color: black; text-decoration:none; font-size:large;"><span class="fas fa-play-circle fa-lg  "></span>&nbsp;  Explanation Video: Unary Operators</a></li>
                                <li><a href="#"class="d-inline-flex align-items-center rounded" style="color: black; text-decoration:none; font-size:large;"><span class="fas fa-sticky-note fa-lg  "></span>&nbsp; Theory Notes: Unary Operators</a></li>
                                <li><a href="#"class="d-inline-flex align-items-center rounded" style="color: black; text-decoration:none; font-size:large;"><span class="fas fa-question-circle fa-lg  "></span>&nbsp; Practice Quiz 2</a></li>
                                <hr>
                ...
                <div class="card" >
                        ...
                        <button class="btn d-inline-flex align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#module3_collapse" aria-expanded="true" style="font-size:larger"aria-current="true" >
                             <strong>Module 3: Taking Input in JAVA</strong> &nbsp; <i class="fas fa-arrow-circle-down fa-lg d-flex justify-content-between"></i>
                            </button>
                        </div>
                        <div id="module3">
