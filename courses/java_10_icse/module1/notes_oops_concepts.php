...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title> OOPs Concepts - Code At Random</title>
    </head>
    <style>
        body {
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module1-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module1/notes_oops_concepts.php" class="d-inline-flex align-items-center rounded active">Notes: OOPs Concepts</a></li>
                ...
                <div class="bd-intro ps-lg-4">
                    ...
                    <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
                            <tr>
                                ...
                                <td><a href="../../../notes/Object Oriented Programming (OOPs) Concepts.pdf" target="_blank" download="OOPs Concepts" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                    </table>
