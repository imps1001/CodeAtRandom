                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module1-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module1/elementary_concepts_java.php" class="d-inline-flex align-items-center rounded active">Video: Elementary Concepts OF Java</a></li>
