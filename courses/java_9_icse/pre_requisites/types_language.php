...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
        ...
        <title>Types of Languages</title>
    </head>
    <style>
        body {
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="customize-collapse">
                                <ul class="list-unstyled fw-normal pb-2 small">
                                    ...
                                    <li><a href="../../java_9_icse/pre_requisites/types_language.php" class="d-inline-flex align-items-center rounded pb-1 active">Video: Types Of Language</a></li>
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse" id="module3-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_9_icse/module3/board_practice.php" class="d-inline-flex align-items-center rounded">Board Questions: Progtramming</a></li>
            ...
            <main class="bd-main order-1">
                <div class="bd-intro ps-lg-4">
                    <div class="d-md-flex flex-md-rowalign-items-center justify-content-between">
                        <h3 class="bd-title" id="content">Types Of Languages</h3>
                    </div>
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://www.youtube.com/embed/iGY7JMObpoY?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Java Tokens"></iframe></div>
                        <div class="completed_button" style="text-align: center; padding-top: 40px;">
                        <a href="./reading_introduction_to_java.php">
