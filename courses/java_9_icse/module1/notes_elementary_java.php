...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
       ...
       <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
        ...
        <title> Elementary Concepts of Java - Code At Random</title>
    </head>
    <style>
        body {
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module1-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_10_icse/module1/notes_elementary_java.php" class="d-inline-flex align-items-center rounded active">Notes: Elementary Concepts OF Java</a></li>
