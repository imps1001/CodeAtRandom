...
if (isset($_SESSION['email'])) { ?>
    ...
    <head>
       ...
       <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
        ...
        <title> JAVA Features - Code At Random</title>
    </head>
    <style>
        body {
                    ...
                    <ul class="list-unstyled mb-0 py-3 pt-md-1">
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse" id="customize-collapse">
                                <ul class="list-unstyled fw-normal pb-2 small">
                                <li><a href="../../java_9_icse/pre_requisites/introduction_computers.php" class="d-inline-flex align-items-center rounded pb-1 active">Video: Introduction To Computers</a></li>
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse show" id="module1-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_9_icse/module1/notes_features.php" class="d-inline-flex align-items-center rounded active"> Notes: Features Of Java</a></li>
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse" id="module7-collapse">
                                <ul class="list-unstyled fw-normal pb-1 small">
                                    ...
                                    <li><a href="../../java_9_icse/module7/constructors.php" class="d-inline-flex align-items-center rounded">Constructors in Java</a></li>
                ...
                <div class="bd-intro ps-lg-4">
                    ...
                    <table style="margin-top: 5px; border-collapse: collapse; width: 100%;">
                            <tr>
                                ...
                                <td><a href="../../../notes/Introduction To JAVA.pdf" target="_blank" download="Introduction To JAVA" style="font-weight: 700; color:green; text-decoration:none;">Download The PDF here.</a></td>
                            </tr>
                    </table>
